...
%.o : %.dev.bc %.host.o
	clang-offload-bundler -type=o -targets=sycl-spir64_gen-unknown-unknown,host-x86_64-unknown-linux-gnu -outputs=main.o -inputs=$*.dev.bc,$*.host.o
...
clean :
	rm -f main *.o *.header.hpp *.footer.hpp *.bc onepass
